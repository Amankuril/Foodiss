...
import { FoodRestaurantOnboardingSettings } from '../models/restaurantOnboardingSettings.model.js';
...
import { GST_RATE } from '../../restaurant/constants.js';
...
/**
 * Restaurant onboarding fee settings.
 */
export const getRestaurantOnboardingSettings = async () => {
    const settings = await FoodRestaurantOnboardingSettings.findOne();
...
export const updateRestaurantOnboardingSettings = async (data) => {
    let settings = await FoodRestaurantOnboardingSettings.findOne();
    if (!settings) {
        settings = new FoodRestaurantOnboardingSettings();
    }
    ...
    await settings.save();
    return getRestaurantOnboardingSettings();
};
