...
import { Bell, Menu, ChevronDown, Calendar, Download, FileText, Wallet, X, ArrowUpRight, History, TrendingUp, Receipt } from "lucide-react"
      ...
      <div className="flex-1 overflow-y-auto px-4 pt-6 pb-28 md:px-8 md:pt-7 md:pb-8 md:min-h-0">
        {activeTab === "payouts" && (
          <div className="space-y-6 md:grid md:grid-cols-[minmax(280px,340px)_minmax(0,1fr)] md:gap-8 md:space-y-0 md:items-start">
            ...
            <div className="md:col-start-1 md:row-start-1 md:row-span-3 md:sticky md:top-0">
