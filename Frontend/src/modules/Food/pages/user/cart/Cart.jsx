...
export default function Cart() {
  ...
  // COD availability from public feature settings
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      const googleEnabled = await isGoogleOrderRoadDistanceEnabled()
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // Cash on Delivery: order placed without online payment
