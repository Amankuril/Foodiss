...
export const adminAPI = {
  ...
  /** POST /food/auth/admin/forgot-password/request-otp – only accepts registered admin email */
  ...
  getRestaurantOnboardingSettings: () =>
    apiClient.get("/food/admin/restaurant-onboarding-settings", {
      contextModule: "admin",
    }),
  ...
  updateRestaurantOnboardingSettings: (body) =>
    apiClient.patch("/food/admin/restaurant-onboarding-settings", body, {
      contextModule: "admin",
    }),
  getFeatureSettings: () =>
...
export const restaurantAPI = {
  ...
  getOnboardingSettings: () =>
    apiClient.get("/food/admin/restaurant-onboarding-settings/public", {
      contextModule: "restaurant",
    }),
