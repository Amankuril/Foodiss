module.exports = {
  apps: [
    ...
    {
      name: 'foodiss-worker-notification',
      cwd: './Backend',
    ...
    {
      name: 'foodiss-worker-maintenance',
      cwd: './Backend',
